...
final _chains = {
  ...
  'Solana Devnet': {'type': 'solana', 'rpc': 'https://api.devnet.solana.com', 'explorer': 'https://explorer.solana.com'},
  'Sui Testnet': {'type': 'sui', 'rpc': 'https://fullnode.testnet.sui.io:443', 'explorer': 'https://suiscan.xyz/testnet'},
};
                    ...
                    ..._transactions.map(
                      (tx) => InkWell(
                        onTap: () => launchUrlString(
                          '${_chains[_selectedTxChain]?['explorer']}/tx/${tx.$1}''${_selectedTxChain == 'Solana Devnet' ? '?cluster=devnet' : ''}',
